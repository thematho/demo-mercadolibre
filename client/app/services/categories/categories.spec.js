...
describe('Module ng6Starter.categories', () => {

  // Load involved Modules
  beforeEach(window.module(CategoriesModule));
  ...
  describe('CategoriesService', () => {
    ...
    beforeEach(inject(($injector) => {
      ...
      getService = () => {
        ...
        // return $injector.get('CategoriesService');
        return new CategoriesService(...injections);
      },
